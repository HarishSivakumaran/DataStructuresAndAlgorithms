...
public class DukeWeek2 {
    ...
    public void howManyGenes() {
        ...
        System.out.println("How many genes are: " + count+"TOTAL"+ total);
    }
    ...
    public void processGenes() {
        ...
        System.out.println(cgRatio(dna)+"cgratio");
        System.out.println(countCTG(dna)+"ctgcount");
        howManyGenes();
    ...
    public static void main(String[] args){
        ...
        DukeWeek2 dukeWeek2 = new DukeWeek2();
        dukeWeek2.processGenes();
